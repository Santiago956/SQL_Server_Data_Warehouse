...
------------------------------------------
	...
	Os dados serão carregados a partir de arquivos CSV localizados na pasta datasets/source
	Essa procedure é para carga total e trunca as tabelas antes de carregar os dados.

	Atenção: Os caminhos dos arquivos CSV devem ser ajustados conforme o ambiente de execução.
