...
IF OBJECT_ID ('prata.crm_prd_info', 'U') IS NOT NULL
	DROP TABLE prata.crm_prd_info;
...
IF OBJECT_ID ('prata.crm_sales_details', 'U') IS NOT NULL
	DROP TABLE prata.crm_sales_details;
...
IF OBJECT_ID ('prata.erp_cust_az12', 'U') IS NOT NULL
	DROP TABLE prata.erp_cust_az12;
...
IF OBJECT_ID ('prata.erp_px_cat_g1v2', 'U') IS NOT NULL
	DROP TABLE prata.erp_px_cat_g1v2;
